...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-mesh flex">
      {/* Left Panel - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-sky-500 to-slate-800 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/2 left-1/3 w-48 h-48 rounded-full bg-sky-300/20 blur-2xl" />
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            />
            <h1 className="text-2xl font-bold text-stone-800">Shen3D</h1>
          </div>
          ...
          <div className="glass-card p-8 rounded-xl">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white border-2 border-stone-200 rounded-xl text-stone-700 font-semibold hover:border-amber-500 hover:bg-orange-50 transition-all duration-300 shadow-sm hover:shadow-md hover:scale-[1.02]"
            >
            ...
            <div className="flex items-center gap-4 my-6">
              ...
              <span className="text-sm text-stone-400 font-medium">{t('auth.or')}</span>
              <div className="flex-1 h-px bg-stone-200" />
            </div>
            ...
            <div className="space-y-3">
              <button
                onClick={handleGoogleLogin}
                className="w-full px-6 py-3 bg-stone-800 text-white rounded-xl font-semibold hover:scale-[1.02] transition-all duration-300 flex items-center justify-center gap-2 shadow-sm shadow-slate-800/20 hover:shadow-md hover:bg-stone-700"
              >
                <Shield size={20} />
                {t('auth.loginAsLab')}
              </button>
              <button
                ...
                className="w-full px-6 py-3 bg-green-700 text-white rounded-xl font-semibold hover:scale-[1.02] transition-all duration-300 flex items-center justify-center gap-2 shadow-sm shadow-teal-500/20 hover:shadow-md hover:bg-green-800"
              >
                <CheckCircle size={20} />
            ...
            {/* Demo Notice */}
            <div className="mt-6 p-4 bg-orange-50 rounded-xl border border-sky-100">
