...
export default function GenerateReportModal({
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="flex items-center gap-3 p-4 border-b border-stone-100 shrink-0 bg-gradient-to-r from-green-50/80 to-transparent">
        ...
        {/* Hint banner */}
        <div className="px-4 py-2.5 bg-green-50/60 border-b border-emerald-100 text-[11px] text-green-800">
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  />
                  <span className="text-xs font-bold text-stone-800 flex-1">
                    {mg.label}
                  </span>
                ...
                <div className="divide-y divide-neutral-100">
                  {mg.cases.map((c) => (
                    <label
                      key={c.id}
                      className="flex items-center gap-2.5 px-3 py-2 cursor-pointer hover:bg-stone-50/60"
                    >
                      <input
                        type="checkbox"
