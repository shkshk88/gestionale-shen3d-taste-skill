...
export default function CreateDocumentModal({
 ...
 <p className="text-[10px] text-gray-400 uppercase tracking-wide">{t('billing.create_modal.title')}</p>
 ...
 <div className=" border border-gray-100 overflow-hidden divide-y divide-neutral-100 max-h-44 overflow-y-auto">
 {cases.map((c) => (
 <label
 key={c.id}
 ...
 />
 <span className="font-mono text-xs text-blue-600">{c.caseNumber}</span>
 {c.patientName && (
 <span className="text-xs text-gray-500 truncate flex-1">— {c.patientName}</span>
 )}
 <span className="text-xs font-semibold text-gray-700 shrink-0 ml-auto">
 ...
 className="flex-[2] py-2.5 bg-blue-600 text-white text-sm font-semibold flex items-center justify-center gap-2 hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
 >
