...
export default function ClientProfile() {
 ...
 checked ? 'bg-gray-800 shadow-slate-800/20' : 'bg-gray-200'
 }`}
 >
 <div
 ...
 <div className="w-12 h-12 flex items-center justify-center text-white font-bold text-lg shadow-sky-500/15 shrink-0">
 {studioInfo.name.split(' ').map(w => w[0]).join('').slice(0, 2)}
 </div>
 <div className="min-w-0">
 <p className="text-lg font-bold text-gray-800 truncate">{studioInfo.name}</p>
 <p className="text-xs text-gray-500">{t('portal.clientSince', { date: new Date(studioInfo.memberSince).toLocaleDateString(i18n.language, { month: 'long', year: 'numeric' }) })}</p>
 </div>
 </div>

 {/* Stats - Vibrant Cards */}
 <div className="grid grid-cols-3 gap-2 md:gap-4">
 <div className=" md: p-3 md:p-5 shadow-slate-800/15">
 <div className="flex items-center gap-2 md:gap-3 mb-1 md:mb-2">
 <div className="w-6 h-6 md:w-10 md:h-10 md: bg-white/20 flex items-center justify-center">
 ...
 <div className=" to-sky-600 md: p-3 md:p-5 shadow-sky-500/15">
 <div className="flex items-center gap-2 md:gap-3 mb-1 md:mb-2">
 <div className="w-6 h-6 md:w-10 md:h-10 md: bg-white/20 flex items-center justify-center">
 ...
 <div className=" md: p-3 md:p-5 shadow-teal-500/15">
 <div className="flex items-center gap-2 md:gap-3 mb-1 md:mb-2">
 <div className="w-6 h-6 md:w-10 md:h-10 md: bg-white/20 flex items-center justify-center">
 ...
 <div className="w-10 h-10 bg-white flex items-center justify-center border border-gray-100">
 <User size={18} className="text-gray-500" />
 </div>
 <div>
 <p className="text-xs text-gray-400 font-medium">{t('clients.contactPerson')}</p>
 <p className="font-semibold text-gray-800">{studioInfo.contactPerson}</p>
 </div>
 </div>
 <div className="flex items-center gap-3 p-3 bg-gray-50 ">
 <div className="w-10 h-10 bg-white flex items-center justify-center border border-gray-100">
 ...
 <div>
 <p className="text-xs text-gray-400 font-medium">{t('clients.phone')}</p>
 <p className="font-semibold text-gray-800">{studioInfo.phone}</p>
 </div>
 </div>
 <div className="flex items-center gap-3 p-3 bg-gray-50 ">
 <div className="w-10 h-10 bg-white flex items-center justify-center border border-gray-100">
 ...
 <div>
 <p className="text-xs text-gray-400 font-medium">{t('clients.email')}</p>
 <p className="font-semibold text-gray-800">{studioInfo.email}</p>
 </div>
 </div>
 <div className="flex items-center gap-3 p-3 bg-gray-50 ">
 <div className="w-10 h-10 bg-white flex items-center justify-center border border-gray-100">
 ...
 <div>
 <p className="text-xs text-gray-400 font-medium">{t('clients.address')}</p>
 <p className="font-semibold text-gray-800">{studioInfo.address}</p>
 </div>
 </div>
 </div>
 ...
 ? 'bg-gray-800 text-white shadow-slate-800/15'
 ...
 <div>
 <p className="font-semibold text-gray-800">Notifiche push</p>
 <p className="text-sm text-gray-500">Ricevi notifiche sullo stato dei casi</p>
 </div>
 <ToggleSwitch
 ...
 <div className="flex items-center justify-between p-4 bg-gray-50 ">
 <div>
 <p className="font-semibold text-gray-800">Notifiche email</p>
 ...
 <button className="w-full flex items-center justify-between p-4 bg-gray-50 hover:bg-gray-100 transition-all duration-200 group">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 bg-white flex items-center justify-center border border-gray-100">
 <Shield size={18} className="text-gray-500 group-hover:text-blue-600 transition-colors" />
 </div>
 <span className="font-semibold text-gray-800">Cambia password</span>
 </div>
 ...
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 bg-white flex items-center justify-center border border-gray-100">
 <Clock size={18} className="text-gray-500 group-hover:text-blue-600 transition-colors" />
 </div>
 <div className="text-left">
 <span className="font-semibold text-gray-800 block">Sessioni attive</span>
 <span className="text-sm text-gray-500">1 sessione attiva</span>
 </div>
 </div>
 <ChevronRight size={18} className="text-gray-400 group-hover:text-gray-600 transition-colors" />
 </button>
 ...
 {/* Contact Lab */}
 <div className=" p-6 shadow-sky-500/15">
 ...
 className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 text-sm font-semibold text-white hover:bg-white/30 transition-all duration-200"
 >
 <Phone size={16} />
 Chiama
 </a>
