...
export default function CaseConfirmation() {
 ...
 <div className=" to-teal-500 p-5 text-center relative overflow-hidden">
 ...
 <span className="ml-auto inline-flex items-center gap-1.5 px-3 py-1.5 bg-white/15 shrink-0">
 ...
 {/* Patient — prominent */}
 <div className="flex items-center gap-3 bg-white p-3 border border-gray-100 ">
 <div className="w-9 h-9 bg-sky-100 flex items-center justify-center shrink-0">
 <User size={18} className="text-blue-600" />
 </div>
 <div className="min-w-0">
 <p className="text-[10px] font-medium text-gray-500 uppercase tracking-wide">Paziente</p>
 <p className="font-semibold text-gray-800 truncate" dir="auto">{patientName}</p>
 </div>
 </div>

 {/* Compact info grid */}
 <div className="grid grid-cols-3 gap-2">
 <div className="bg-white p-2.5 text-center border border-gray-100 ">
 <Calendar size={15} className="text-blue-600 mx-auto mb-1" />
 <p className="text-[9px] font-medium text-gray-500 uppercase tracking-wide">{t('portal.deliveryExpected')}</p>
 ...
 <p className="text-[9px] font-medium text-gray-500 uppercase tracking-wide">File</p>
 <p className="text-sm font-semibold text-gray-800 leading-tight mt-0.5">{fileCount || 0}</p>
 </div>
 <div className="bg-white p-2.5 text-center border border-gray-100 ">
 <Flag size={15} className={`mx-auto mb-1 ${priority === 'urgent' ? 'text-blue-600' : 'text-blue-500'}`} />
 <p className="text-[9px] font-medium text-gray-500 uppercase tracking-wide">{t('newCase.priorityLabel')}</p>
 <p className="text-sm font-semibold text-gray-800 leading-tight mt-0.5">
 ...
 <span
 key={num}
 className="w-6 h-6 bg-gray-50 text-[11px] font-medium text-gray-700 flex items-center justify-center border border-gray-100"
 >
 {num}
 </span>
 ))}
 ...
 {/* One-line note */}
 <p className="text-xs text-sky-700 bg-gray-50 border border-sky-100 px-3 py-2 text-center">
 ...
 <Link
 to="/portal/cases"
 className="flex-1 flex items-center justify-center gap-2 px-5 py-3 bg-gray-800 text-white font-semibold hover:bg-gray-700 transition-all shadow-slate-800/15"
 >
 ...
 <Link
 to="/portal/new-case"
 className="flex-1 flex items-center justify-center gap-2 px-5 py-3 bg-white text-gray-700 border-2 border-gray-200 font-semibold hover:border-blue-500 hover:text-blue-500 transition-all"
 >
 <PlusCircle size={18} />
