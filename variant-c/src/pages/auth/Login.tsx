...
export default function LoginPage() {
 ...
 <div className="absolute top-20 left-20 w-64 h-64 bg-white/10 blur-3xl" />
 <div className="absolute bottom-40 right-10 w-96 h-96 bg-white/10 blur-3xl" />
 <div className="absolute top-1/2 left-1/3 w-48 h-48 bg-sky-300/20 blur-2xl" />
 </div>
 ...
 src="/logo-shen3d.png"
 alt="Shen3D Logo"
 className="h-24 w-auto drop-"
 />
 </div>
 <h1 className="text-5xl font-bold mb-4 drop-">Shen3D</h1>
 ...
 />
 <h1 className="text-2xl font-bold text-gray-800">Shen3D</h1>
 </div>
 ...
 className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white border-2 border-gray-200 text-gray-700 font-semibold hover:border-gray-500 hover:bg-gray-50 transition-all hover: hover:scale-[1.02]"
 >
 ...
 <button
 onClick={handleGoogleLogin}
 className="w-full px-6 py-3 bg-gray-800 text-white font-semibold hover:scale-[1.02] transition-all flex items-center justify-center gap-2 shadow-slate-800/20 hover: hover:bg-gray-700"
 >
 <Shield size={20} />
 {t('auth.loginAsLab')}
 </button>
 ...
 className="w-full px-6 py-3 bg-blue-500 text-white font-semibold hover:scale-[1.02] transition-all flex items-center justify-center gap-2 shadow-teal-500/20 hover: hover:bg-blue-600"
 >
 <CheckCircle size={20} />
 ...
 {/* Demo Notice */}
 <div className="mt-6 p-4 bg-gray-50 border border-sky-100">
