...
function MobileBottomNavBase({ items, fabPath, accentColor }: MobileBottomNavProps) {
  ...
  return (
    <nav
      className="fixed bottom-3 left-3 right-3 z-50 md:hidden bg-white/90 backdrop-blur-xl border border-slate-200/60 rounded-[1.75rem] h-[68px] grid grid-cols-5 items-center shadow-elevated safe-area-inset-bottom"
    ...
    >
      ...
      <button
        ...
        className={`w-12 h-12 mx-auto -mt-5 rounded-2xl ${accentColor} text-white flex items-center justify-center shadow-soft-lg active:scale-95 transition-transform`}
