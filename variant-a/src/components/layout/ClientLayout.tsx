  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-surface md:bg-grain">
      ...
      <aside className="hidden md:flex fixed start-3 top-3 bottom-3 w-[72px] bg-white/90 backdrop-blur-xl border border-slate-200/60 rounded-[1.5rem] flex-col items-center py-5 gap-1 z-50 shadow-elevated">
        ...
        {import.meta.env.DEV && (
          <button
            ...
            className="w-10 h-10 flex items-center justify-center rounded-xl text-slate-400 hover:text-brand hover:bg-brand/5 transition-all duration-200"
        ...
        <button
          ...
          className="w-10 h-10 flex items-center justify-center rounded-xl text-slate-400 hover:text-red-500 hover:bg-red-50 transition-all duration-200"
        >
      ...
      <main className="flex-1 flex flex-col mx-2 md:ms-[88px] md:me-3 my-2 md:my-3 mb-24 md:mb-3 overflow-hidden relative">
        {/* Header */}
        <header className="h-[68px] mb-3 bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-[1.5rem] px-5 flex items-center justify-between z-40 shrink-0 shadow-soft">
          <div className="flex flex-col min-w-0">
            <h1 className="text-xl font-semibold text-slate-800 font-display tracking-tight">{t('portal.headerTitle')}</h1>
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <button className="hidden md:flex relative w-9 h-9 rounded-xl bg-surface-secondary hover:bg-white items-center justify-center text-slate-500 hover:text-slate-800 transition-all border border-slate-200/60">
