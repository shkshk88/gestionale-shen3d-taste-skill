        ...
        <div className="w-full max-w-md">
          ...
          <div className="glass-card p-8 rounded-2xl">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white border-2 border-slate-200 rounded-2xl text-slate-700 font-semibold hover:border-sky-500 hover:bg-sky-50 transition-all duration-300 shadow-sm hover:shadow-md hover:scale-[1.02]"
            >
            ...
            <div className="space-y-3">
              <button
                onClick={handleGoogleLogin}
                className="w-full px-6 py-3 bg-slate-800 text-white rounded-2xl font-semibold hover:scale-[1.02] transition-all duration-300 flex items-center justify-center gap-2 shadow-sm shadow-slate-800/20 hover:shadow-md hover:bg-slate-700"
              >
                <Shield size={20} />
                {t('auth.loginAsLab')}
              </button>
              <button
                ...
                className="w-full px-6 py-3 bg-teal-500 text-white rounded-2xl font-semibold hover:scale-[1.02] transition-all duration-300 flex items-center justify-center gap-2 shadow-sm shadow-teal-500/20 hover:shadow-md hover:bg-teal-600"
              >
                <CheckCircle size={20} />
