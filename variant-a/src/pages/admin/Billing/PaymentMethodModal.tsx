...
const METHOD_DEFS: {
  ...
  { type: 4, i18nKey: 'cash', icon: Banknote, color: 'text-emerald-700', bg: 'bg-emerald-50 border-emerald-200' },
  { type: 3, i18nKey: 'bank_transfer', icon: Building, color: 'text-sky-700', bg: 'bg-sky-50 border-sky-200' },
    ...
    >
      ...
      >
        ...
        <div className="p-4 space-y-4 overflow-y-auto">
                ...
                >
                  ...
                  <p
                    className={`text-sm font-semibold mt-1 ${
                      isActive ? m.color : 'text-slate-700'
                    }`}
                  >
          ...
          {method === 4 && (
            <p className="text-xs text-emerald-700 px-3 py-2 bg-emerald-50/40 rounded-xl border border-emerald-100">
        ...
        {/* Footer */}
        <div className="border-t border-slate-100 p-4 bg-slate-50/60 shrink-0 flex gap-2">
          <button
            onClick={onClose}
          ...
          <button
            ...
            disabled={loading}
            className="flex-[2] py-2.5 rounded-xl bg-sky-600 hover:opacity-90 text-white text-sm font-semibold flex items-center justify-center gap-2 disabled:opacity-50"
          >
