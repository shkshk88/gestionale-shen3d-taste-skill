...
export default function GenerateReportModal({
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="flex items-center gap-3 p-4 border-b border-slate-100 shrink-0 bg-gradient-to-r from-green-50/80 to-transparent">
        ...
        {/* Hint banner */}
        <div className="px-4 py-2.5 bg-emerald-50/60 border-b border-emerald-100 text-[11px] text-green-800">
              ...
              >
                ...
                <div className="divide-y divide-neutral-100">
                  {mg.cases.map((c) => (
                    <label
                      key={c.id}
                      className="flex items-center gap-2.5 px-3 py-2 cursor-pointer hover:bg-slate-50/60"
                    >
                      <input
                        type="checkbox"
                        ...
                        className="w-4 h-4 accent-green-600 shrink-0"
                      />
                      <span className="font-mono text-xs text-sky-600 shrink-0">
                        {c.caseNumber}
                      </span>
        ...
        <div className="border-t border-slate-100 p-4 bg-slate-50/60 shrink-0">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex-[2] py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
